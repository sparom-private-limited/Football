  ...
  return (
    <MainLayout title="Create Team">
      <View style={styles.container}>
        ...
        <Input label="Founded Year" keyboardType="numeric" value={form.foundedYear} onChange={(v) => setForm({ ...form, foundedYear: v })} />

        <TouchableOpacity style={[styles.primaryBtn, saving && { opacity: 0.7 }]} onPress={createTeam} disabled={saving}>
          <Text style={styles.primaryBtnText}>{saving ? "Creating..." : "Create Team"}</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  coverBox: {
    height: 160, backgroundColor: "#E2E8F0", borderRadius: 14, justifyContent: "center", alignItems: "center",
    marginBottom: 20, overflow: "hidden",
  },
  coverImg: { width: "100%", height: "100%" },

  logoBox: {
    height: 100, width: 100, borderRadius: 60, backgroundColor: "#E2E8F0", alignSelf: "center",
    justifyContent: "center", alignItems: "center", overflow: "hidden", marginBottom: 25,
  },
